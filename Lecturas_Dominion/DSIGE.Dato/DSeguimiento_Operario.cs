...
namespace DSIGE.Dato
{
    public class DSeguimiento_Operario
    {
     ...
     //   }
        ...
        public List<UbicacionOperario_GPS> DSeguimientoOperario_GPS_Reparto(string pFechaAsiga, int servicio, int operario, string suministro, string medidor, string fechaEntrega)
        {
            try
            {
                List<UbicacionOperario_GPS> lOb = new List<UbicacionOperario_GPS>();
                //using (IDataReader iDr = DatabaseFactory.CreateDatabase().ExecuteReader("SP_S_SEGUIMIENTO_OPERARIO_MOVIL_REPARTO_NEW", pFechaAsiga, servicio, operario, suministro, medidor, fechaEntrega))
                using (IDataReader iDr = DatabaseFactory.CreateDatabase().ExecuteReader("SP_S_SEGUIMIENTO_OPERARIO_MOVIL_REPARTO_II", pFechaAsiga, servicio, operario, suministro, medidor, fechaEntrega))
                {
                    if (iDr != null)
                    {
        ...
        public List<Seguimiento_Operarios_E> Capa_Dato_get_Operario_Gps(string FechaAsiga, int servicio, int operario, string fechaEntrega)
        {
            try
            {
                var cadenaCnx = System.Configuration.ConfigurationManager.ConnectionStrings["dataSige"].ConnectionString;
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("PROC_S_EFECTIVIDAD_MAPA_OPERARIOGPS_II", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public List<Seguimiento_Operarios_E> Capa_Dato_get_Suministros_Mapa(string FechaAsiga, int servicio, int operario, string fechaEntrega)
        {
            try
            {
                var cadenaCnx = System.Configuration.ConfigurationManager.ConnectionStrings["dataSige"].ConnectionString;
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("PROC_S_EFECTIVIDAD_MAPA_SUMINISTROS_II", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@fecha", SqlDbType.VarChar).Value = FechaAsiga;
        ...
        public List<Seguimiento_Operarios_E> Capa_Datos_get_Suministros_Trabajados(string FechaAsiga, int servicio, int operario, string fechaEntrega)
        {
            try
            {
                var cadenaCnx = System.Configuration.ConfigurationManager.ConnectionStrings["dataSige"].ConnectionString;
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("PROC_S_EFECTIVIDAD_MAPA_SUMINISTROS_LEIDOS_II", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@fecha", SqlDbType.VarChar).Value = FechaAsiga;
