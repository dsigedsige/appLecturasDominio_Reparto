...
namespace DSIGE.Dato
{
    public class Cls_Dato_AsignaOrdenTrabajo
    {
        ...
        public List<Cls_Entidad_AsignaOrdenTrabajo.validacion> Capa_Dato_Get_ListaLecturaEnviarCliente_Validacion(int estado, string fechaAsignacion, string estado_new, int resultado, int id_supervisor, int id_operario_supervisor, int servicio)
        {
            try
            {
                cadenaCnx = System.Configuration.ConfigurationManager.ConnectionStrings["dataSige"].ConnectionString;
                ...
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_S_ENVIAR_CLIENTE_VALIDACION_LECTURAS_RELECTURA", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string Capa_Dato_Set_procesarRecepcion_Trabajos(int servicio, string fechaAsigna, int idUsuario )
        {
            cadenaCnx = System.Configuration.ConfigurationManager.ConnectionStrings["dataSige"].ConnectionString;
            string Resultado = "";
            try
            {
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_S_PROCESO_RECEPCION_new", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
        ...
        public object Capa_Dato_get_grandesClientes(int estado, string fecha_inicial, string fecha_final, string codigoEmr , int operario)
        {
            DataTable dt_detalle = new DataTable();
            try
            {
                ...
                using (SqlConnection cn = new SqlConnection(cadenaCnx))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand("SP_S_LECTURA_GRANDES_CLIENTES", cn))
                    {
                        ...
                        cmd.Parameters.Add("@idOperario", SqlDbType.Int).Value = operario;
        ...
        public object Capa_Dato_download_grandesClientes(int estado, string fecha_inicial, string fecha_final, string codigoEmr, int id_usuario, int operario)
        {
        ...
        public string GenerarArchivoExcel_grandesClientes(DataTable dt_detalles, string nombreFile, string nombreExcel)
        {
            ...
            try
            {
                ...
                using (Excel.ExcelPackage oEx = new Excel.ExcelPackage(_file))
                {
                    ...
                    oWs.Cells[9, 1, 9, 8].Merge = true;  // combinar celdaS dt
                    ...
                    oWs.Cells[9, 10, 9, 13].Merge = true;  // combinar celdaS dt
                    oWs.Cells[9, 10].Value = "CORRECTOR";
                    oWs.Cells[9, 10].Style.HorizontalAlignment = Style.ExcelHorizontalAlignment.Center;
                    oWs.Cells[9, 10].Style.VerticalAlignment = Style.ExcelVerticalAlignment.Center;
                    oWs.Cells[9, 10].Style.Font.Bold = true; //Letra negrita
                    ...
                    oWs.Cells[10, 6].Value = "OPERARIO";

                    oWs.Cells[10, 7].Value = "NIVEL DE LEL(%) ";
                    oWs.Cells[10, 8].Value = "PRESIÓN ENTRADA(BAR)";
                    oWs.Cells[10, 9].Value = "CONTADOR MECÁNICO(m3)";
                    oWs.Cells[10, 10].Value = "VOL.ACC.SIN CORREGIR(m3)";

                    oWs.Cells[10, 11].Value = "VOL.ACC.CORREGIDO(Std m3)";
                    oWs.Cells[10, 12].Value = "PRESIÓN(Bara)";

                    oWs.Cells[10, 13].Value = "TEMP.(ºC)";
                    oWs.Cells[10, 14].Value = "TIEMPO BATERÍA(Días/%)";
                    oWs.Cells[10, 15].Value = "OBSERVACIONES";
                    ...
                    foreach (DataRow oBj in dt_detalles.Rows)
                    {
                        ...
                        oWs.Cells[_fila, 7].Value = oBj["nivelel_porc"].ToString();
                        oWs.Cells[_fila, 8].Value = oBj["presion_entrada_bar"].ToString();
                        oWs.Cells[_fila, 9].Value = oBj["contador_mecanico_m3"].ToString();
                        oWs.Cells[_fila, 10].Value = oBj["vol_acc_sin_corregir_m3"].ToString();

                        oWs.Cells[_fila, 11].Value = oBj["vol_acc_corregido_std_m3"].ToString();
                        oWs.Cells[_fila, 12].Value = oBj["presion_bara"].ToString();

                        oWs.Cells[_fila, 13].Value = oBj["temp"].ToString();
                        oWs.Cells[_fila, 14].Value = oBj["tiempo_bateria_dias"].ToString();
                        oWs.Cells[_fila, 15].Value = oBj["observaciones"].ToString();
        ...
        public object Capa_Negocio_download_grandesClientes_All_download(int estado, string fecha_inicial, string fecha_final, string codigoEmr, int id_usuario, int tipo, int operario)
        {
            DataTable dt_detalle = new DataTable();
        ...
        public object Capa_Dato_download_grandesClientes_All_download_v2(int estado, string fecha_inicial, string codigoEmr, int id_usuario, int tipo, int operario)
        {
            DataTable dt_detalle = new DataTable();
            List<download> list_files = new List<download>();
            string rutaFoto = "";
        ...
        public object Capa_Dato_download_liquidacionOT(int id_tipo_servicio, int estado, string suministro, string medidor, string fechaInicial, string fechaFinal, string tipoCliente, int id_supervisor, int id_operario_supervisor, int id_usuario)
        {

            string resultado;
            string nombreFile = id_usuario + "_reporteLiquidacionOrdenTrabajo.xlsx";
            ...
            try
            {
                ...
                {
                    cn.Open();
                    using (SqlCommand cmd = new SqlCommand("NEW_DSIGE_S_REPORTE_LIQUIDACION_OT_EXCEL", cn))
                    {
                        cmd.CommandTimeout = 0;
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.Parameters.Add("@idTipoServicio", SqlDbType.Int).Value = id_tipo_servicio;
                        ...
                        using (SqlDataAdapter da = new SqlDataAdapter(cmd))
                        {
                            ...
                            {
                                resultado = GenerarArchivoExcel_liquidacionOT(dt_detalle, nombreFile, "liquidacionOT");
                            }
                        }
                    }
                }
        ...
        public string GenerarArchivoExcel_liquidacionOT(DataTable dt_detalles, string nombreFile, string nombreExcel)
        {
            string _ruta = "";
            string Res = "";
            int _fila = 2;
            ...
            try
            {
                ...
                using (Excel.ExcelPackage oEx = new Excel.ExcelPackage(_file))
                {
                    ...
                    oWs.Cells[1, 1].Value = "TIPO";
                    oWs.Cells[1, 2].Value = "INSTALACIÓN";
                    oWs.Cells[1, 3].Value = "MEDIDOR";
                    oWs.Cells[1, 4].Value = "CTA.CTO";

                    oWs.Cells[1, 5].Value = "EMPRESA LECTORA";
                    oWs.Cells[1, 6].Value = "AVISO";                              
                    oWs.Cells[1, 7].Value = "FECHA DE AVISO";
                    oWs.Cells[1, 8].Value = "FECHA LECTURA";

                    oWs.Cells[1, 9].Value = "VALOR LECTURA";
                    oWs.Cells[1, 10].Value = "NOTA LECTURA";                              
                    oWs.Cells[1, 11].Value = "COMENTARIO";
                    oWs.Cells[1, 12].Value = "OBSERVACIÓN ";
                              
                    oWs.Cells[1, 13].Value = "TECNICO";
  

                   foreach (DataRow oBj in dt_detalles.Rows)
                    {
                        oWs.Cells[_fila, 1].Value = oBj["tipo"].ToString();
                        oWs.Cells[_fila, 2].Value = oBj["instalacion"].ToString();
                        oWs.Cells[_fila, 3].Value = oBj["medidor"].ToString();
                        oWs.Cells[_fila, 4].Value = oBj["ctaContrato"].ToString();

                        oWs.Cells[_fila, 5].Value = oBj["empresaLectora"].ToString();
                        oWs.Cells[_fila, 6].Value = oBj["aviso"].ToString();
                        oWs.Cells[_fila, 7].Value = oBj["fechaAviso"].ToString();
                        oWs.Cells[_fila, 8].Value = oBj["fechaLectura"].ToString();

                        oWs.Cells[_fila, 9].Value = oBj["valorLectura"].ToString();
                        oWs.Cells[_fila, 10].Value = oBj["notaLectura"].ToString();
                        oWs.Cells[_fila, 11].Value = oBj["comentario"].ToString();

                        oWs.Cells[_fila, 12].Value = oBj["observacion"].ToString();
                        oWs.Cells[_fila, 13].Value = oBj["tecnico"].ToString();
