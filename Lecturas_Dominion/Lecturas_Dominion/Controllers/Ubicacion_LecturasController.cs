...
namespace DSIGE.Web.Controllers
{
    public class Ubicacion_LecturasController : Controller
    {
        ...
        [HttpPost]
        public string ListandoOperariosGrandesClientes()
        {
            object loDatos;
            try
            {
                NUbicacion_Lecturas obj_negocio = new NUbicacion_Lecturas();
                loDatos = obj_negocio.Capa_Negocio_Get_ListaOperariosGrandesClientes();
                return _Serialize(loDatos, true);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public string ListandoOperarios_servicio(int servicio)
        {
            object loDatos;
            try
            {
                NUbicacion_Lecturas obj_negocio = new NUbicacion_Lecturas();
                loDatos = obj_negocio.Capa_Negocio_Get_ListaOperarios_servicio(servicio);
                return _Serialize(loDatos, true);
            }
            catch (Exception ex)
            {
