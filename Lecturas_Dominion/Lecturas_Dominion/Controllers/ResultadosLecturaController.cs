...
namespace DSIGE.Web.Controllers
{
    public class ResultadosLecturaController : Controller
    {
        ...
        public ActionResult index_ResultadosDia()
        {
            return View();
        }
        ...
        [HttpPost]
        public string ListandoResumenReparto(string FechaAsignacion, int id_tiposervicio, string ciclo)
        {
            object loDatos;
            try
            {
                ResultadoLecturas_BL obj_negocio = new ResultadoLecturas_BL();
                loDatos = obj_negocio.Capa_Negocio_Get_ListaResumenReparto(FechaAsignacion, id_tiposervicio, ciclo);
                return _Serialize(loDatos, true);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public string ListandoResumenReparto_Detallado(string FechaAsignacion, int id_tiposervicio,  string ciclo)
        {
            object loDatos;
            try
            {
                ResultadoLecturas_BL obj_negocio = new ResultadoLecturas_BL();
                loDatos = obj_negocio.Capa_Negocio_Get_ListaReparto_Detallado(FechaAsignacion, id_tiposervicio, ciclo);
                return _Serialize(loDatos, true);
            }
            catch (Exception ex)
            {
