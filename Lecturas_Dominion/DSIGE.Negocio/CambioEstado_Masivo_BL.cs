...
namespace DSIGE.Modelo
{
    public class CambioEstado_Masivo_BL
    {
        public string Capa_Negocio_get_CambioEstado_Masivo(int local, int servicio, int operario,  string fecha_Asigna, int usuario)
       {
        ...
        public string Capa_Negocio_GenerarAnular_Masivo(int servicio, string fecha_Asigna, int estado, int operario, int usuario, string archivosImportado, int usuarioImportacion)
        {
            try
            {
                Cls_Dato_CambioEstado Objeto_Dato = new Cls_Dato_CambioEstado();
                return Objeto_Dato.Capa_Dato_GenerarAnular_Masivo(servicio, fecha_Asigna, estado, operario, usuario, archivosImportado, usuarioImportacion);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_archivosCargados(int id_servicio, string fecha_asignacion)
        {
            try
            {
                Cls_Dato_CambioEstado Objeto_Dato = new Cls_Dato_CambioEstado();
                return Objeto_Dato.Capa_Dato_Get_archivosCargados(id_servicio, fecha_asignacion);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_usuariosImportacion(int id_servicio, string fecha_asignacion)
        {
            try
            {
                Cls_Dato_CambioEstado Objeto_Dato = new Cls_Dato_CambioEstado();
                return Objeto_Dato.Capa_Dato_Get_usuariosImportacion(id_servicio, fecha_asignacion);
            }
            catch (Exception e)
            {
                throw e;
