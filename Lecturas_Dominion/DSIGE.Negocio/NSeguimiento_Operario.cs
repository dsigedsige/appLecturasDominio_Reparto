...
namespace DSIGE.Negocio
{
    public class NSeguimiento_Operario
    {
        ...
        public List<UbicacionOperario_GPS> NSeguimientoOperario_GPS_reparto(string pFechaAsiga, int servicio, int operario, string suministro, string medidor, string fechaEntrega)
        {
            try
            {
                return new DSeguimiento_Operario().DSeguimientoOperario_GPS_Reparto(pFechaAsiga, servicio, operario, suministro, medidor, fechaEntrega);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_get_Operario_Gps(string FechaAsiga, int servicio, int operario, string fechaEntrega)
        {
            try
            {
                return new DSeguimiento_Operario().Capa_Dato_get_Operario_Gps(FechaAsiga, servicio, operario, fechaEntrega);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_get_Suministros_Mapa(string FechaAsiga, int servicio, int operario, string fechaEntrega)
        {
            try
            {
                return new DSeguimiento_Operario().Capa_Dato_get_Suministros_Mapa(FechaAsiga, servicio, operario, fechaEntrega);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_get_Suministros_Trabajados(string FechaAsiga, int servicio, int operario, string fechaEntrega)
        {
            try
            {
                return new DSeguimiento_Operario().Capa_Datos_get_Suministros_Trabajados(FechaAsiga, servicio, operario, fechaEntrega);
            }
            catch (Exception e)
            {
                throw e;
