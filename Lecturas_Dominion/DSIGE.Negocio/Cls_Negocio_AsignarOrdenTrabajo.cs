...
namespace DSIGE.Negocio
{
    public class Cls_Negocio_AsignarOrdenTrabajo
    {
        ...
        public object Capa_Negocio_getGrandesClientes(int estado, string fecha_inicial, string fecha_final, string codigoEmr, int operario)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_get_grandesClientes(estado, fecha_inicial, fecha_final, codigoEmr, operario);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_download_grandesClientes(int estado, string fecha_inicial, string fecha_final, string codigoEmr, int id_usuario , int operario  )
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_download_grandesClientes(estado, fecha_inicial, fecha_final, codigoEmr, id_usuario, operario);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_download_grandesClientes_All_download(int estado, string fecha_inicial, string fecha_final, string codigoEmr, int id_usuario, int opcion, int operario)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Negocio_download_grandesClientes_All_download(estado, fecha_inicial, fecha_final, codigoEmr, id_usuario, opcion, operario);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public object Capa_Negocio_download_grandesClientes_All_download_v2(int estado, string fecha_inicial, string codigoEmr, int id_usuario, int opcion, int operario)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_download_grandesClientes_All_download_v2(estado, fecha_inicial, codigoEmr, id_usuario, opcion, operario);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public List<Cls_Entidad_AsignaOrdenTrabajo.validacion> Capa_Negocio_Get_ListaLecturaEnviarCliente_Validacion(int estado, string fechaAsignacion, string estado_new, int resultado, int id_supervisor, int id_operario_supervisor, int servicio)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_Get_ListaLecturaEnviarCliente_Validacion( estado, fechaAsignacion, estado_new,resultado, id_supervisor , id_operario_supervisor, servicio);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public string Capa_Negocio_Set_procesarRecepcion_Trabajos(int servicio, string fechaAsigna, int idUsuario)
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_Set_procesarRecepcion_Trabajos(servicio, fechaAsigna, idUsuario);
            }
            catch (Exception e)
            {
                throw e;
       ...
       public string Capa_Negocio_set_anulando_unidad_lectura(string Cod_UnidadLectura,  int id_usuario)
        ...
        public object Capa_Negocio_download_liquidacionOT(int id_tipo_servicio, int estado, string suministro, string medidor, string fechaInicial, string fechaFinal, string tipoCliente, int id_supervisor, int id_operario_supervisor, int id_usuario )
        {
            try
            {
                Cls_Dato_AsignaOrdenTrabajo Objeto_Dato = new Cls_Dato_AsignaOrdenTrabajo();
                return Objeto_Dato.Capa_Dato_download_liquidacionOT(id_tipo_servicio, estado, suministro, medidor, fechaInicial, fechaFinal, tipoCliente, id_supervisor, id_operario_supervisor, id_usuario);
            }
            catch (Exception e)
            {
                throw e;
