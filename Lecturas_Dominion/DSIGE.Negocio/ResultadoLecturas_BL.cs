...
namespace DSIGE.Negocio
{
    public class ResultadoLecturas_BL
    {
        ...
        public List<ResultadoLecturas_E> Capa_Negocio_Get_ListaResumenReparto(string FechaAsignacion, int id_tiposervicio, string ciclo)
        {
            try
            {
                Cls_Dato_ResultadoLecturas Objeto_Dato = new Cls_Dato_ResultadoLecturas();
                return Objeto_Dato.Capa_Dato_Get_ResumenReparto(FechaAsignacion, id_tiposervicio , ciclo);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public List<ResultadoLecturas_E> Capa_Negocio_Get_ListaReparto_Detallado(string FechaAsignacion, int id_tiposervicio, string ciclo)
        {
            try
            {
                Cls_Dato_ResultadoLecturas Objeto_Dato = new Cls_Dato_ResultadoLecturas();
                return Objeto_Dato.Capa_Dato_Get_ResumenReparto_Detallado(FechaAsignacion, id_tiposervicio, ciclo);
            }
            catch (Exception e)
            {
                throw e;
