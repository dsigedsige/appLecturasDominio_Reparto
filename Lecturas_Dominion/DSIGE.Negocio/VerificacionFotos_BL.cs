...
namespace DSIGE.Modelo
{
    public class VerificacionFotos_BL
    {
        ...
        public string Capa_Negocio_set_reactivarCuentaContrato(int servicio, string fecha, string contrato, int idUsuario)
        {
            Cls_Dato_VerificacionFotos Objeto_Dato = new Cls_Dato_VerificacionFotos();
            return Objeto_Dato.Capa_Dato_set_reactivarCuentaContrato(servicio, fecha, contrato, idUsuario);
        }
