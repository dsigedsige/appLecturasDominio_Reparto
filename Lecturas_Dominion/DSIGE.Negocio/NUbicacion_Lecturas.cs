...
namespace DSIGE.Negocio
{
    public class NUbicacion_Lecturas
    {
        ...
        public List<Ubicacion_Lectura> Capa_Negocio_Get_ListaOperariosGrandesClientes()
        {
            try
            {
                DUbicacion_Lecturas Objeto_Dato = new DUbicacion_Lecturas();
                return Objeto_Dato.Capa_Dato_Get_ListaOperariosGrandesClientes();
            }
            catch (Exception e)
            {
                throw e;
        ...
        public List<Ubicacion_Lectura> Capa_Negocio_Get_ListaOperarios_servicio(int idServicio)
        {
            try
            {
                DUbicacion_Lecturas Objeto_Dato = new DUbicacion_Lecturas();
                return Objeto_Dato.Capa_Dato_Get_ListaOperarios_servicio(idServicio);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public List<UbicacionOperario> NSeguimiento_Lecturas_III(string pFechaAsiga, int servicio, int operario, string suministro, string medidor, string fechaEntrega)
        {
            try
            {
                return new DUbicacion_Lecturas().DSeguimiento_Lectura_III(pFechaAsiga, servicio, operario, suministro, medidor, fechaEntrega);
            }
            catch (Exception e)
            {
                throw e;
